...
static int cmd_dc_config( const struct shell * shell,
                          size_t argc,
                          char ** argv )
{
...
static int cmd_dc_config_pdn_id( const struct shell * shell,
                                 size_t argc,
                                 char ** argv )
{
    if( argc != 2 )
...
static int cmd_dc_config_sec_tag( const struct shell * shell,
                                  size_t argc,
                                  char ** argv )
{
    if( argc != 2 )
...
static int cmd_dc_connect( const struct shell * shell,
                           size_t argc,
                           char ** argv )
{
    int err;
...
static int cmd_dc_pause( const struct shell * shell,
                         size_t argc,
                         char ** argv )
{
    if( argc != 1 )
...
static int cmd_dc_resume( const struct shell * shell,
                          size_t argc,
                          char ** argv )
{
    if( argc != 1 )
...
static int cmd_dc_download( const struct shell * shell,
                            size_t argc,
                            char ** argv )
{
    int err;
...
static int cmd_dc_disconnect( const struct shell * shell,
                              size_t argc,
                              char ** argv )
{
